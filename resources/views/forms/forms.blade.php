    ...
    <div class="row">
        <div class="col-12">
            ...
            <form method="post" action="/forms" enctype="multipart/form-data">
                ...
                <a id="dinkesbtn" style="color:white " class="btn btn-primary">Dinas Kesehatan</a>
                        ...
                        <div id="posbindu" class="tab-pane fade">
                            ...
                            <div class="form-row">
                                <div class="col">
                                    ...
                                    <input type="text" class="form-control" id="nama_lengkap_bindu" name="nama_lengkap_bindu" placeholder=" Masukkan Nama Lengkap Bindu">
                                </div>
                                <div class="col">
                                    <label for="nama_bindu">Nama Bindu</label>
                                    <input type="text" class="form-control" id="nama_bindu" name="nama_bindu" placeholder="Masukkan Nama Bindu">
                                </div>
                                <div class="col">
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="riwayat_ptm_keluarga_bindu" name="riwayat_ptm_keluarga_bindu" value="ada">
                                            </td>
                                            <td style="text-align: center;"><input type="radio" id="riwayat_ptm_keluarga_bindu" name="riwayat_ptm_keluarga_bindu" value="tidak">
                                            </td>
                                        </tr>
                                        ...
                                        <tr>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="riwayat_ptm_sendiri_bindu" name="riwayat_ptm_sendiri_bindu" value="ada">
                                            </td>
                                            <td style="text-align: center;"> <input type="radio" id="riwayat_ptm_sendiri_bindu" name="riwayat_ptm_sendiri_bindu" value="tidak">
                                            </td>
                                        </tr><br>
                                    </tbody>
                                </table>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="merokok_bindu" name="merokok_bindu" value="ya"></td>
                                            <td style="text-align: center;"> <input type="radio" id="merokok_bindu" name="merokok_bindu" value="tidak"></td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <b> <label for="kurang_aktivitas_fisik_bindu">Kurang Aktifitas Fisik</label></b>
                                            </td>
                                            <td style="text-align: center;"> <input type="radio" id="kurang_aktivitas_fisik_bindu" name="kurang_aktivitas_fisik_bindu" value="ya"></td>
                                            <td style="text-align: center;"> <input type="radio" id="kurang_aktivitas_fisik_bindu" name="kurang_aktivitas_fisik_bindu" value="tidak"></td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="kurang_sayur_buah_bindu" name="kurang_sayur_buah_bindu" value="ya"></td>
                                            <td style="text-align: center;"> <input type="radio" id="kurang_sayur_buah_bindu" name="kurang_sayur_buah_bindu" value="tidak"> </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <b> <label for="konsumsi_alkohol_bindu">Konsumsi Alkohol</label></b>
                                            </td>
                                            <td style="text-align: center;"> <input type="radio" id="konsumsi_alkohol_bindu" name="konsumsi_alkohol_bindu" value="ya"></td>
                                            <td style="text-align: center;"> <input type="radio" id="konsumsi_alkohol_bindu" name="konsumsi_alkohol_bindu" value="tidak"></td>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="tekanan_darah_bindu" name="tekanan_darah_bindu" value="normal"></td>
                                            <td style="text-align: center;"> <input type="radio" id="tekanan_darah_bindu" name="tekanan_darah_bindu" value="ht"></td><br>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                ...
                                <table>
                                    ...
                                    <tbody>
                                        <tr>
                                            ...
                                            <td style="text-align: center;"><input type="radio" id="lingkar_perut_bindu" name="lingkar_perut_bindu" value="normal"> </td>
                                            <td style="text-align: center;"><input type="radio" id="lingkar_perut_bindu" name="lingkar_perut_bindu" value="lebih"> </td>
                                        </tr>
                                        <tr>
                                            <td>
                                            ...
                                            <td style="text-align: center;"> <input type="radio" id="gula_darah_acak_bindu" name="gula_darah_acak_bindu" value="normal"> </td>
                                            <td style="text-align: center;"> <input type="radio" id="gula_darah_acak_bindu" name="gula_darah_acak_bindu" value="lebih"> </td>
                                        </tr>
                                        <tr>
                                            <td>
                                                <b> <label for="kolestrol_bindu">Kolesterol</label></b>
                                            </td>
                                            <td style="text-align: center;"> <input type="radio" id="kolestrol_bindu" name="kolestrol_bindu" value="normal"> </td>
                                            <td style="text-align: center;"><input type="radio" id="kolestrol_bindu" name="kolestrol_bindu" value="lebih"> </td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                            ...
                            <div class="form-group">
                                ...
                                <input type="file" class="form-control-file" id="foto_posbindu" placeholder="Masukkan Foto Posbindu" name="foto_posbindu">
                            </div>
                        </div>
                ...
                <a id="dp5abtn" style="color:white " class="btn btn-primary">DP5A</a>
                ...
                <a id="dkrthbtn" style="color:white " class="btn btn-primary">DKRTH</a>
                <div id="mydkrth">
                    <ul class="nav nav-tabs">
