...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="row">
                <form action="/schema" method="get" class="form-inline">
                    @csrf
                    <div class="col-12">
                ...
                <br>
                <a href="/schema/kembalikan_semua" class="btn btn-success btn-sm" onclick="return confirm('Apakah anda yakin data ini akan dikembalikan semua?')">Kembalikan Semua</a>&nbsp;&nbsp;
