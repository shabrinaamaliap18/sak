    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <div class="row">
                ...
                <br>
                <a href="/menu/kembalikan_semua" class="btn btn-success btn-sm" onclick="return confirm('Apakah anda yakin data ini akan dikembalikan semua?')">Kembalikan Semua</a>&nbsp;&nbsp;
