...
<head>
    ...
    <title>Login &mdash; SIADER</title>
        ...
        <section class="section">
            <div class="d-flex flex-wrap align-items-stretch">
                <div class="col-lg-4 col-md-6 col-12 order-lg-1 min-vh-100 order-2 bg-white">
                    <div class="p-4 m-3">
                        ...
                        <h4 class="text-dark font-weight-normal">Selamat Datang di <span
                                class="font-weight-bold">SIADER</span>
                        </h4>
                        <p class="text-muted">Sebelum memulai, silahkan login terlebih dahulu</p>
                        <form method="GET" action="{{route('loginotentikasi')}}" class="needs-validation" novalidate="">
                            @csrf
                            ...
                            <div class="text-center mt-5 text-small">
                                Copyright &copy; PKL. Made with 💙 by KELOMPOK PKL
                                <div class="mt-2">
                ...
                <div class="col-lg-8 col-12 order-lg-2 order-1 min-vh-100 background-walk-y position-relative overlay-gradient-bottom"
                    data-background="../assets/img/unsplash/login-bg2.jpg">
                    <div class="absolute-bottom-left index-2">
                        <div class="text-light p-5 pb-2">
                            ...
                            Photo by <a class="text-light bb" target="_blank"
                                href="https://unsplash.com/photos/yVwiHXoTrnU">Rasyid Maulana</a> on <a
