            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddkrth/teruskan/{{$forms->id}}"
                                ...
                                @if ($keputusan->keputusan_dkrth == "1")
                                <span class="badge badge-success">Terima</span><br>
                                @endif
                                @if ($keputusan->keputusan_dkrth == "0")
                                ...
                                <br>
                                <input type="hidden" value="{{$forms->status}}" id="keputusan_dkrth"
                                    name="keputusan_dkrth">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddkrth/teruskanhonor/{{$forms->id}}"
                                enctype=" multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <input type="hidden" value="{{$forms->id}}" id="id_form" name="id_form">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddkrth/revisi/{{$forms->id}}"
                                enctype=" multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <input type="hidden" value="{{$forms->id}}" id="id_form" name="id_form">
