...
<div class="container">
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            ...
            <a href="/alllaporan/tambah" class=" btn btn-info">Tambah Laporan</a> &nbsp;&nbsp;
            <a href="/alllaporan/trash" class="btn btn-warning fas fa-trash"></a>
            &nbsp;&nbsp;
            <a href="/alllaporan " class="btn btn-info fas fa-redo"></a><br> <br>
