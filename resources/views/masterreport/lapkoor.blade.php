    ...
    <div class="row">
        <div class="col-lg-12 col-md-12 col-12">
            <div class=" section-header">
                <h1>Daftar Report </h1>&nbsp;&nbsp;&nbsp;&nbsp;
                <a href="/lapkoor " class="btn btn-info fas fa-redo"></a>

            </div>

            <!-- <div class="cari">
                <form action="/masterreport/lapkoor" method="get" class="form-inline">
                    @csrf
                    <div class="col-12">
            ...
            <table id="myTable" class="table table-striped table-bordered nowrap" style="width:100%">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <a class="fas fa-folder" href="/lapkoor/show/{{$as->id}}"></a>
                            &nbsp;&nbsp;
