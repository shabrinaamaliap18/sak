                        ...
                        <table>
                            <tbody>
                                <tr>
                                    ...
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->nama_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Umur Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->umur_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">NIK Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->nik_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Nama Suami</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->nama_suami}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Alamat Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->alamat_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Kondisi Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->kondisi_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Kasus Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->kasus_ibu_hamil}}</td>
                                </tr>
                                <tr>
                                    <td width="300px">Keterangan Ibu</td>
                                    <td width="20px">:</td>
                                    <td> {{$ibuhamil->keterangan_ibu_hamil}}</td>
                                </tr>
                            </tbody>
                        </table>
                        <table>
                            <tbody>
                                ...
                                <tr>
                                    <td> <img class="img" width="500px" src="/image/{{$ibuhamil->foto_ibu_hamil}}"></td>
                                </tr>
                            </tbody>
                        </table>
                        @endforeach
