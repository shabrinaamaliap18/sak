            ...
            <div class="card">
                <div class="card-body">
                    ...
                    <div class="row mt-1">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddinkes/teruskan/{{$forms->id}}"
                                enctype=" multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <input type="hidden" value="{{$forms->id}}" id="id_form" name="id_form">
                                <input type="hidden" value="{{$forms->acc_din}}" id="keputusan_dinkes"
                                    name="keputusan_dinkes">
                                <label>Keputusan Anda : </label>
                                @foreach ($keputusan as $keputusan)
                                @if ($keputusan->keputusan_dinkes == "1")
                                <span class="badge badge-success">Terima</span><br>
                                @endif
                                @if ($keputusan->keputusan_dinkes == "0")
                                ...
                                <br>
                                <input type="hidden" value="{{$forms->status}}" id="keputusan_dinkes"
                                    name="keputusan_dinkes">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddinkes/teruskanhonor/{{$forms->id}}"
                                enctype=" multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <input type="hidden" value="{{$forms->id}}" id="id_form" name="id_form">
                        ...
                        <div class="col-md-4 form-group">
                            <form method="post" action="/lapopddinkes/revisi/{{$forms->id}}"
                                enctype=" multipart/form-data">
                                {{ csrf_field() }}
                                {{ method_field('PUT') }}
                                <input type="hidden" value="{{$forms->id}}" id="id_form" name="id_form">
