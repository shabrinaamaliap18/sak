...
class RekapLaporanController extends Controller
{
    public function index()
    {
        ...
        return view('rekap.rekaplaporan', ['forms' => $forms], ['pegawai' => $pegawai]);
    }
    ...
    public function show(Request $request, Form $forms, $id)
    {
        ...
        return view('rekap.rekaplaporan-show', compact('forms', 'pegawai','penduduk', 'tim', 'tim2', 'posyandu', 'satgas_pbkm', 'fasil', 'pegawai', 'tim2', 'history', 'history2', 'history3', 'history4', 'history5'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('rekap.rekaplaporan-date', compact('forms', 'query'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        return view('rekap.rekaplaporan', compact('forms', 'skipped'));
    }
}