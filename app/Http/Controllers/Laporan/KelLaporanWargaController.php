...
class KelLaporanWargaController extends Controller
{
    public function index()
    {
        ...
        return view('laporan.kellaporanwarga', ['forms' => $forms], ['pegawai' => $pegawai]);
    }
    ...
    public function show(Request $request, Form $forms, $id)
    {
        ...
        return view('rekap.kellaporanwarga-show', compact('forms', 'pegawai','penduduk', 'tim', 'tim2', 'posyandu', 'satgas_pbkm', 'fasil', 'pegawai', 'tim2', 'history', 'history2', 'history3', 'history4', 'history5'));
    }
    ...
    public function search(Request $request)
    {
        ...
        return view('rekap.kellaporanwarga-date', compact('forms', 'query'));
    }
    ...
    public function cari(Request $request)
    {
        ...
        return view('laporan.kellaporanwarga', compact('forms', 'skipped'));
    }
}